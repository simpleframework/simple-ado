 ...
 */
public class HSQLJdbcDialect extends DefaultJdbcDialect {

	@Override
	public String toLimitSQL(final String sql, final int i, final int fetchSize) {
		final StringBuilder sb = new StringBuilder();
		sb.append("select limit ").append(i).append(" ").append(fetchSize).append(sql.substring(6));
		return sb.toString();
	}

	@Override
	protected String getDbType() {
		return DatabaseMeta.HSQL;
	}
}
